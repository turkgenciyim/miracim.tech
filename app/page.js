...
export default function Home () {
  return (
    <main>
      <header className="relative py-4 pb-12 overflow-hidden bg-gradient-to-tr from-blue-900 via-slate-950 to-sky-950 group/container">
        <nav className="container flex flex-col items-center justify-center p-4 mx-auto sm:flex-row">
          {/* <h1 className="text-3xl font-bold tracking-tight text-center xs:w-1/2 sm:w-1/3 text-slate-100">
            Morena Aka SleepyHead
          </h1> */}
          <div className="flex flex-wrap justify-center flex-1 mt-6 uppercase xs:mt-0 lg:gap-4 md:flex-nowrap sm:w-1/3 sm:basis-1/2">
            <Link
              className="flex items-center justify-center px-3 py-3 pr-0 space-x-2 font-medium tracking-tight transition-all border border-transparent rounded-lg select-none basis-1/2 sm:basis-36 md:basis-auto sm:hover:bg-slate-800 sm:active:border-slate-700 text-slate-300 group sm:hover:pr-6 hover:text-white"
              href={'/#aboutme'}
            >
              <span> About</span>
              <svg
        ...
        <div className="container relative z-30 py-12 mx-auto">
          <div className="flex flex-col items-center justify-center gap-4 mx-auto max-w-fit ">
            ...
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-2xl font-bold tracking-tight uppercase xs:text-3xl sm:text-4xl text-slate-100">
                Selammm Ben Miraç! 😉
              </h1>
              <p className="text-sm font-medium tracking-tight text-center xs:text-base text-slate-400">
                Developer, Social Managment <br /> Manager and insurance
                personel
              </p>
            </div>
