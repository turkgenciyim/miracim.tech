...
export default function Home () {
  ...
  const introHeaderIcons = {
    hidden: {y: 5, opacity: 0.05, scale: 0.90},
    visible: {
      y: 0,
      opacity: 1,
      scale: 1,
  ...
  return (
    <main>
      ...
      <div className="relative flex flex-col items-center justify-center gap-4 p-12 shadow bg-gradient-to-r from-slate-900 via-gray-800 to-slate-900 about-gradient rounded-b-3xl">
        <motion.h2
          initial="hide"
          whileInView="show"
          exit="hide"
