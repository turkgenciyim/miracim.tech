...
const Header = () => {
  return (
    <header className='relative pt-6 pb-12 overflow-hidden bg-gradient-to-tr from-violet-900 via-slate-950 to-purple-950 group/container'>
      ...
      <div className='container relative z-30 py-12 mx-auto'>
        <div className='flex flex-col items-center justify-center gap-4 mx-auto max-w-fit'>
          ...
          <h2 className='my-8 font-sans text-6xl font-bold tracking-tighter text-center text-transparent xs:text-7xl sm:text-8xl bg-clip-text bg-gradient-to-tr from-violet-500 via-purple-400 to-indigo-600'>
            <div className='relative inline-block'>
              <span className='relative z-20 text-transparent bg-clip-text title'>
                Full Stack
              </span>{' '}
              <span className='absolute inset-0 z-10 text-transparent skew-x-6 bg-indigo-950 skew-y-2 -rotate-2 rounded-2xl'></span>
            </div>{' '}
          ...
          <div className='flex flex-wrap justify-center gap-4'>
            <Link
              ...
              target='_blank'
              className='relative flex w-64 py-5 pl-8 pr-20 overflow-hidden text-lg font-bold text-white duration-500 shadow bg-slate-800 rounded-xl group hover:bg-slate-700 drop-shadow-xl active:scale-95'
            >
              <span className='z-10'>Github Profile</span>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='absolute w-24 h-24 transition-all duration-700 -translate-y-1/2 -right-8 top-1/2 fill-slate-600 group-hover:fill-blue-100'
                viewBox='0 0 24 24'
              >
            ...
            <Link
              href={'https://www.linkedin.com/in/mirac-adsw/'}
              className='relative flex w-64 py-5 pl-8 pr-20 overflow-hidden text-lg font-bold duration-500 bg-blue-500 shadow text-blue-50 rounded-xl group hover:bg-blue-600 drop-shadow-xl active:scale-95'
            >
              <span className='z-10'>LinkedIn Profile</span>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='absolute w-16 h-16 transition-all duration-700 -translate-y-1/2 -right-2 top-1/2 fill-blue-100 group-hover:fill-white'
                viewBox='0 0 24 24'
              >
