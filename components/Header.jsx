        ...
        <div className="flex flex-col items-center justify-center gap-4 mx-auto max-w-fit">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              ...
              target="_blank"
              className="relative flex w-64 py-5 pl-8 pr-20 overflow-hidden text-lg font-bold text-white duration-500 shadow active:scale-95 bg-slate-900 rounded-xl group hover:bg-slate-800 drop-shadow-xl"
            >
              <span className="z-10">Github Profile</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="absolute w-24 h-24 transition-all duration-700 -translate-y-1/2 -right-8 top-1/2 fill-slate-600 group-hover:fill-violet-600"
                viewBox="0 0 24 24"
              >
            ...
            <Link
              ...
              href={"/"}
              className="relative flex w-64 py-5 pl-8 pr-20 overflow-hidden text-lg font-bold text-white duration-500 shadow active:scale-95 bg-sky-500 rounded-xl group hover:bg-sku-600 drop-shadow-xl"
            >
