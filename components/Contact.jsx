...
const Showcase = () => {
  ...
  return (
    ...
    >
      ...
      <Link href={"https://discord.com/users/619925060387340299"} className='flex items-center justify-between gap-8 py-4 pl-10 pr-6 text-lg transition-all bg-white shadow md:py-5 md:pr-8 hover:bg-violet-500 group md:pl-14 rounded-xl'>
        <span className='inline-block font-bold tracking-tight uppercase transition-all text-slate-800 group-hover:text-white'>
          Bana yazın
        </span>
        <BiLogoDiscordAlt className='w-10 h-10 transition-all fill-violet-500 group-hover:fill-white' />
      </Link>
    </motion.div>
  )
}
