...
const Skills = () => {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center bg-no-repeat bg-cover bg-[url("/skill-pattern.png")] gap-12 pt-12 px-12 md:pb-12 m-2.5 bg-bottom rounded-xl'>
      <motion.h2
        initial='hide'
        id='becerilerim'
        whileInView='show'
