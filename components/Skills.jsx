...
const Skills = () => {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center gap-12 p-12 m-2.5 bg-gradient-to-r from-slate-900 via-gray-800 to-slate-900 about-gradient rounded-xl'>
      <motion.h2
        initial='hide'
        id='yetenekler'
        whileInView='show'
      ...
      >
        <motion.li variants={introHeaderIcons} className="relative z-10">
          <div className="absolute hidden h-10 px-3 py-1 font-bold text-white translate-x-1/2 -translate-y-1/2 -z-10 sm:block bg-gradient-to-tr from-blue-500 to-cyan-600 -top-4 right-1/2 rounded-t-2xl">
            NextJS
          </div>
          <SiNextdotjs className="z-20 w-16 h-16 p-3 transition-all duration-200 shadow cursor-pointer select-none xs:p-4 xs:w-28 xs:h-28 active:scale-95 hover:scale-105 bg-gradient-to-tr from-violet-500 to-cyan-600 rounded-2xl fill-slate-200 hover:fill-white" />
        </motion.li>
